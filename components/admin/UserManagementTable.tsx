...
// PERBAIKAN: Menggunakan UserDashboardData menggantikan UserProps
export default function UserManagementTable({ users }: { users: UserDashboardData[] }) {
                        ...
                        {users.map((u, index) => {
                            ...
                            return (
                                <tr key={u.id} className={`hover:bg-slate-50/80 transition-colors ${selectedUsers.includes(u.id) ? 'bg-blue-50/50' : ''}`}>
                                    ...
                                    <td className="px-2 py-5 text-center text-slate-400 font-semibold">{index + 1}</td>
                                    ...
                                    <td className="px-5 py-5">
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {/* UI Badge IP yang sudah dipertegas */}
