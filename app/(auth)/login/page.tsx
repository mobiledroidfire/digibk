...
import { Loader2, GraduationCap, ShieldCheck, BrainCircuit, ActivitySquare } from 'lucide-react';
        ...
        <main className="flex min-h-screen bg-white">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-slate-50 lg:bg-white relative">
                <div className="w-full max-w-md">
                    ...
                    {/* BAGIAN LOGO UNTUK HP (Hanya muncul saat di HP/Layar Kecil) */}
                    ...
                    <div className="bg-white lg:bg-transparent p-8 lg:p-0 rounded-3xl shadow-xl lg:shadow-none ring-1 ring-slate-200 lg:ring-0">
                        ...
                        {isStudentMode ? (
                            <form action={studentAction} className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                ...
                                {/* TAMBAHAN BARU: Nomor Absen / NISN untuk identifikasi unik */}
